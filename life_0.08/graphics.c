...
space_array[5][6].life_exist=1;
space_array[5][7].life_exist=1;
space_array[5][8].life_exist=1;
space_array[6][7].life_exist=1;
space_array[6][5].life_exist=1;
space_array[7][7].life_exist=1;
space_array[5][8].life_exist=1;
space_array[8][6].life_exist=1;
space_array[8][7].life_exist=1;*/
...
while (gtk_events_pending ())
          gtk_main_iteration ();
		if (abc==1)
		for (i=2;i<hor_size-2;i++)
		{
			
			for (j=2;j<vert_size-2;j++)
			{
